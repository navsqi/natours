        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Log in is success');
...
function mapBox(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibmF1dmFsc2giLCJhIjoiY2s5ODVkd2RyMG00NTNudGExazdjeTV1eSJ9.WFNWw7D4uJgCwFUeHC1Nqw';
...
function _updateUser() {
  _updateUser = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    var url, response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var stripe = Stripe('pk_test_uCnNZoRgP23bDfqNm4tzc6op00vdQy9m7X');
...
function _bookTour() {
  _bookTour = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    var response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var bookButton = document.querySelector('#book-tour'); // LOGIN
...
if (formUserData) {
  formUserData.addEventListener('submit', function (event) {
    ...
    (0, _updateUser.updateUser)(new FormData(formUserData), 'data');
  });
} // btn--save-password
